...
function drawText() {
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(["I love you so much Ishika, more than", "all the time and space in the universe can contain"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        } else {
    ...
    if(frameNumber >= 3000 && frameNumber < 99999){
        ...
        context.fillText("Happy Anniversary <3", canvas.width/2, (canvas.height/2 + 120));
